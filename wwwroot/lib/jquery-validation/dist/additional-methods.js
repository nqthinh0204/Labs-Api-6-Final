...
$.validator.addMethod( "creditcardtypes", function( value, element, param ) {
	...
	if ( param.all ) {
		validTypes = 0x0001 | 0x0002 | 0x0005 | 0x0008 | 0x0010 | 0x0020 | 0x0050 | 0x0080;
	}
	...
	if ( validTypes & 0x0005 && /^(3[47])/.test( value ) ) { // Amex
	...
	if ( validTypes & 0x0050 && /^(3)/.test( value ) ) { // Jcb
		return value.length === 16;
	}
	if ( validTypes & 0x0050 && /^(2131|1800)/.test( value ) ) { // Jcb
		return value.length === 15;
	}
...
*
* @example $.validator.methods.pattern("AR1005",element,/^AR\d{4}$/)
* @result true
*
* @example $.validator.methods.pattern("BR1005",element,/^AR\d{4}$/)
* @result false
*
